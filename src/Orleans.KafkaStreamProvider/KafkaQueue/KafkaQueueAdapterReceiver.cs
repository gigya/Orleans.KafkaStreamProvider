...
namespace Orleans.KafkaStreamProvider.KafkaQueue
{
    public class KafkaQueueAdapterReceiver : IQueueAdapterReceiver
    {
        ...
        // Metrics
        private static readonly Meter MeterConsumedMessagesPerSecond = Metric.Meter("Consumed Messages Per Second", Unit.Events);
        private static readonly Histogram HistogramConsumedMessagesBatchSizes = Metric.Histogram("Consumed Messages Batch Sizes", Unit.Events);
        private static readonly Counter CounterActiveReceivers = Metric.Counter("Active Receivers", Unit.Custom("Receivers"));
        private static readonly Timer TimerTimeToGetMessageFromKafka = Metric.Timer("Time To Get Message From Kafka", Unit.Custom("Fetches"));
        private static readonly Timer TimerTimeToCommitOffset = Metric.Timer("Time To Commit Offset", Unit.Custom("Commits"));
